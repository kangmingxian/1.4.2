...
Page({
  ...
  bindInput: function (e) {
    ...
    if (keywords != ""){
        ...
        wx.request({
          url: appData.mapApi + "place/around?key=fa26c29156482fbf61fa7af100107b8b&keywords=" + keywords + "&location=" + appData.mapInfo.latitude + "," + appData.mapInfo.longitude,
